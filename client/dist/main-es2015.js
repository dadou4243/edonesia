...
let AnalyticsHomeComponent = class AnalyticsHomeComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let BookingItemComponent = class BookingItemComponent {
    constructor() { }
    ngOnInit() { }
};
...
let GiftCardComponent = class GiftCardComponent {
...
GiftCardComponent.ctorParameters = () => [
...
let EditTripComponent = class EditTripComponent {
    constructor(route, tripsService, fb) {
        this.route = route;
        this.tripsService = tripsService;
        this.fb = fb;
    }
    ngOnInit() {
        this.route.paramMap.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])((params) => (this.tripId = params.get('id'))));
...
EditTripComponent.ctorParameters = () => [
...
let TripItemComponent = class TripItemComponent {
    constructor() { }
    ngOnInit() { }
};
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let TripMainComponent = class TripMainComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
const activitiesWithoutPage = ['beach', 'cruises', 'food'];
...
const routes = [
    {
        path: '',
        loadChildren: () => __webpack_require__.e(/*! import() | app-default-app-default-module */ "app-default-app-default-module").then(__webpack_require__.bind(null, /*! ./app-default/app-default.module */ "./src/app/app-default/app-default.module.ts")).then(mod => mod.AppDefaultModule)
    },
    {
        path: 'admin',
        canActivate: [_core_guards_admin_guard_service__WEBPACK_IMPORTED_MODULE_3__["AdminGuard"]],
        loadChildren: () => Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./app-admin/admin.module */ "./src/app/app-admin/admin.module.ts")).then(mod => mod.AdminModule)
    }
    // { path: '**', component: 'NotFoundComponent' }
];
    ...
    ngOnInit() {
        this.jwtService.checkIfTokenValid().subscribe(auth => {
            if (auth) {
                ...
                this.store.dispatch(Object(_store_user__WEBPACK_IMPORTED_MODULE_2__["LoadUserInfo"])({ userID }));
            }
            else {
...
let AdminGuard = class AdminGuard {
    ...
    canActivate() {
        return this.store.pipe(Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_4__["select"])(src_app_store_user__WEBPACK_IMPORTED_MODULE_5__["getUserInfo"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(userInfo => {
...
let AuthInterceptor = class AuthInterceptor {
    ...
    intercept(req, next) {
        ...
        if (idToken &&
            ...
            return next.handle(cloned).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])((event) => {
...
let BookingsService = class BookingsService {
    ...
    getBookings() {
        ...
        // }
            ...
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(result => result.data));
    }
    getBooking(id) {
        // console.log(id);
    ...
    deleteManyBookings(bookingsIds) {
    ...
    updateBooking(booking, overwrite) {
...
let GiftCardsService = class GiftCardsService {
    ...
    getGiftCardsUser(userID) {
        ...
        return this.http
            ...
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(res => res.data));
    }
    addGiftCard(giftCard, userID) {
        console.log('ADD GiftCard SERVICE', giftCard);
        const data = Object.assign({}, giftCard, { userID });
...
GiftCardsService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
...
let UserService = class UserService {
    ...
    getUserInfo(userID) {
        ...
        return this.http
            ...
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(res => res.data));
    }
};
...
const SetCurrentIndex = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Request] Set Current Index', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
const SetActivitiesCurrentIndex = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Request] Set Activities Current Index', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
const SetFormValue = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Request] Set Form Value', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
const SubmitForm = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Request] Submit Form');
const ClearStepsData = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Request] Clear Steps Data');
...
/* harmony import */ var _ngrx_store__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @ngrx/store */ "./node_modules/@ngrx/store/fesm2015/store.js");
/* harmony import */ var _request_actions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./request.actions */ "./src/app/store/request/request.actions.ts");
...
const featureReducer = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createReducer"])(initialState, Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_request_actions__WEBPACK_IMPORTED_MODULE_1__["SetCurrentIndex"], (state, { currentStepIndex }) => (Object.assign({}, state, { currentStepIndex, currentValidationErrors: {} }))), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_request_actions__WEBPACK_IMPORTED_MODULE_1__["SetActivitiesCurrentIndex"], (state, { currentActivitiesStepIndex }) => (Object.assign({}, state, { currentActivitiesStepIndex, currentValidationErrors: {} }))), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_request_actions__WEBPACK_IMPORTED_MODULE_1__["SetFormValue"], (state, { stepValues, validationErrors }) => (Object.assign({}, state, { formValue: Object.assign({}, state.formValue, stepValues), currentValidationErrors: validationErrors }))));
...
const getRequestState = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createFeatureSelector"])('request');
const getCurrentStepIndex = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(getRequestState, (requestState) => requestState.currentStepIndex);
const getCurrentActivitiesStepIndex = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(getRequestState, (requestState) => requestState.currentActivitiesStepIndex);
const getCurrentValidationErrors = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(getRequestState, (requestState) => {
    const stepValidationValues = Object.values(requestState.currentValidationErrors);
    return stepValidationValues.filter((val) => val.isValid === false);
});
const getFormValue = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(getRequestState, (requestState) => requestState.formValue);
const getActivitiesWithoutEmptyOnes = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(getRequestState, (requestState) => requestState.formValue.activities.filter(act => !src_app_app_default_trip_request_data_activities__WEBPACK_IMPORTED_MODULE_1__["activitiesWithoutPage"].includes(act)));
...
const LogoutSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[User] Logout Success');
const LoadUserInfo = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[User] Load User Info', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
const SetUserInfo = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[User] Set User Info', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
const SubmitForm = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Stepper] Submit Form');
const ClearStepsData = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Stepper] Clear Steps Data');
...
let UserEffects = class UserEffects {
    constructor(actions$, userService, authService, jwtService) {
        this.actions$ = actions$;
        this.userService = userService;
        this.authService = authService;
        this.jwtService = jwtService;
        this.login$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(() => this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_user_actions__WEBPACK_IMPORTED_MODULE_4__["Login"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["mergeMap"])(action => this.authService.logIn(action.loginInfo).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((res) => {
            // console.log('userInfo:', res);
            this.jwtService.saveToken(res.token);
            const userInfo = res.user;
            return Object(_user_actions__WEBPACK_IMPORTED_MODULE_4__["LoginSuccess"])({ userInfo });
        })
        // catchError(error => of(AuthApiActions.loginFailure({ error })))
        ))));
        this.loadUser$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(() => this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_user_actions__WEBPACK_IMPORTED_MODULE_4__["LoadUserInfo"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["mergeMap"])(action => {
            // console.log('userID LoadUserInfo Effect:', action.userID);
            return this.userService.getUserInfo(action.userID).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((userInfo) => {
                // console.log('userInfo:', userInfo);
                return Object(_user_actions__WEBPACK_IMPORTED_MODULE_4__["SetUserInfo"])({ userInfo });
            }));
        })));
        this.logout$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(() => this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_user_actions__WEBPACK_IMPORTED_MODULE_4__["Logout"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(() => {
            this.jwtService.destroyToken();
...
/* harmony import */ var _ngrx_store__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @ngrx/store */ "./node_modules/@ngrx/store/fesm2015/store.js");
/* harmony import */ var _user_actions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./user.actions */ "./src/app/store/user/user.actions.ts");
...
const featureReducer = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createReducer"])(initialState, Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_user_actions__WEBPACK_IMPORTED_MODULE_1__["SetUserInfo"], (state, { userInfo }) => (Object.assign({}, state, { isLoggedIn: true, userInfo }))), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_user_actions__WEBPACK_IMPORTED_MODULE_1__["Login"], state => (Object.assign({}, state, { isLoginLoading: true }))), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_user_actions__WEBPACK_IMPORTED_MODULE_1__["LoginSuccess"], (state, { userInfo }) => (Object.assign({}, state, { isLoggedIn: true, userInfo, isLoginLoading: false }))), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_user_actions__WEBPACK_IMPORTED_MODULE_1__["LogoutSuccess"], () => initialState));
...
const getUserState = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createFeatureSelector"])('user');
const getIsLoggedIn = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(getUserState, (userState) => userState.isLoggedIn);
const getUserInfo = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(getUserState, (userState) => userState.userInfo);
const getIsLoginLoading = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(getUserState, (stepperState) => stepperState.isLoginLoading);
